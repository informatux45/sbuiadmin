...
if ($_GET['a'] == 'install') {
	...
	if ($fatal_error == 0) {
		...
		$zipFile     = "sbmagic_latest.zip"; // Local Zip File Path
		$url         = "http://dev.informatux.com/update/net_install/$zipFile";
		...
		<div class="row">
			<div class="one-half">
				<section class="header">
					  <h2 class="title">SBMAGIC CMS Net Installation</h2>
					  ...
					  <img id="sbmagic_download_loader" src="http://dev.informatux.com/update/net_install/gears.svg" style="height: 70px">
					  <br>
					  ...
					  <div class="value-props row">
						<div class="four columns value-prop">
						  <img class="value-img" src="http://dev.informatux.com/update/net_install/feather.svg">
						  Built with mobile in mind
						</div>
						<div class="four columns value-prop">
						  <img class="value-img" src="http://dev.informatux.com/update/net_install/pens.svg">
						  Styles designed with bootstrap
						</div>
						<div class="four columns value-prop">
						  <img class="value-img" src="http://dev.informatux.com/update/net_install/watch.svg">
