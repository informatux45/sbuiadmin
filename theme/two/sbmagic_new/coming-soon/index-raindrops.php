...
if (basename($_SERVER['PHP_SELF']) == 'index-raindrops.php') { 
        ...
        <script src="js/vendor/rainyday.js"></script>
	 	<script>
            ...
            function run() {
                ...
                image.src = '<?php if ($cs['coming-soon-image'] != '') echo _AM_MEDIAS_URL.$cs['coming-soon-image']; else echo './img/rain-bg.jpg'; ?>';  // Background Image URL
            }
        </script>
        <img id="rain_bg" />
