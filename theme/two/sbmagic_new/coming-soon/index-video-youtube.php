...
if (basename($_SERVER['PHP_SELF']) == 'index-video-youtube.php') { 
...
<html class="no-js">
	...
	<body>
		...
		<script type="text/javascript">
			$(function() {
				var options = {
					videoId : '<?php if ($cs['coming-soon-video'] != '') echo $cs['coming-soon-video']; else echo 'Ekr05T9Iaio'; ?>',
					start : 10
				};
