	...
	switch($param) {
		...
		case "admin":
			...
			$modules_order = [_AM_SITE_DIR.'settings.php'
							 ...
							 ,_AM_SITE_DIR.'news.php'
							 ,_AM_SITE_DIR.'pages.php'
							 ,_AM_SITE_DIR.'blocs.php'
							 ,_AM_SITE_DIR.'stats.php'
							];
			...
			if ($module_menu[$module_name]['main']) {
				...
				if (($module_menu[$module_name]['group'] == 'admin' && $sbmagic_user_type == 'admin')
					...
					if (!in_array($module_name, $auth_array)) {			
						...
						$ret_module_menu .= '<i class="fa fa-' . $module_menu[$module_name]['icon'].' fa-fw"></i> '. $module_menu[$module_name]['main'];
