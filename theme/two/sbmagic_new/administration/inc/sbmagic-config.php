...
// ------------------------------------------
// --- Defined Safe Pages
$sb_safe_pages   = ['index','sandbox','settings','cache','server','dashboard','database','explorer','users','logaccess','menu','pages','blocs','medias','transfert','cmsconfig','stats','news','contact','tabbs','toggle','gallery','gmaps','table','toolbarck'];
...
// --- Protocol
define('_AM_SITE_PROTOCOL',						'http://');
define('_AM_SITE_PROTOCOL_S',					'https://');
...
define('_AM_SITE_URL_S',						_AM_SITE_PROTOCOL_S . SBMAGIC_URL);

// --- Site IMG DIR
define('_AM_SITE_IMG_DIR',						SBMAGIC_PATH . '/img/');
// --- Site IMG URL / URL_S
define('_AM_SITE_IMG_URL',						_AM_SITE_PROTOCOL . SBMAGIC_URL . 'img/');
define('_AM_SITE_IMG_URL_S',					_AM_SITE_PROTOCOL_S . SBMAGIC_URL . 'img/');

// --- Site UPLOAD DIR
define('_AM_SITE_IMG_DIR',						SBMAGIC_PATH . '/upload/');
// --- Site UPLOAD URL / URL_S
define('_AM_SITE_IMG_URL',						_AM_SITE_PROTOCOL . SBMAGIC_URL . 'upload/');
define('_AM_SITE_IMG_URL_S',					_AM_SITE_PROTOCOL_S . SBMAGIC_URL . 'upload/');

// --- Site LANG / DIR / URL / URL_S
...
define('_AM_SITE_LANG_URL_S',					_AM_SITE_PROTOCOL_S . SBMAGIC_URL . 'lang/');
...
$sb_admin_pages = array('sandbox','settings','server','dashboard','cache','toolbarck','database','explorer','users');
