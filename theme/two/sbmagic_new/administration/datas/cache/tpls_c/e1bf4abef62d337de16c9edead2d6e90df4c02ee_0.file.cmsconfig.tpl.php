...
/* Smarty version 3.1.29, created on 2016-12-20 14:40:55
  from "/Applications/MAMP/htdocs/sbmagic_new/administration/core/tpls/tpl/system/cmsconfig.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_585934e78e5d83_52031082',
  'file_dependency' => 
  array (
    'e1bf4abef62d337de16c9edead2d6e90df4c02ee' => 
    array (
      0 => '/Applications/MAMP/htdocs/sbmagic_new/administration/core/tpls/tpl/system/cmsconfig.tpl',
      1 => 1476690180,
      2 => 'file',
    ),
  ),
  ...
  array (
    ...
    'file:system/cmsconfig_bar.tpl' => 1,
    'file:sb_footer.tpl' => 1,
  ),
),false)) {
function content_585934e78e5d83_52031082 ($_smarty_tpl) {
?>
...
?>
		...
		<?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:system/cmsconfig_bar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

				
        <?php if ($_smarty_tpl->tpl_vars['action_edit']->value != 'fonts' && $_smarty_tpl->tpl_vars['action_edit']->value != 'seo') {?>
		        ...
		        <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span class="fa fa-gears fa-fw"></span> <strong><?php echo $_smarty_tpl->tpl_vars['legend_add_edit']->value;?>
</strong>
                        </div>
                        <!-- /.panel-heading -->
                ...
                <div class="col-lg-4">
                    <div class="panel panel-red">
                        ...
                        <div class="panel-body">
							...
							<?php if ($_smarty_tpl->tpl_vars['action_edit']->value == 'headerfooter') {?>
								<?php echo $_smarty_tpl->tpl_vars['cmsconfig_headerfooter_help']->value;?>
							
							<?php } elseif ($_smarty_tpl->tpl_vars['action_edit']->value == 'email') {?>
								<?php echo $_smarty_tpl->tpl_vars['cmsconfig_email_help']->value;?>

							<?php } elseif ($_smarty_tpl->tpl_vars['action_edit']->value == 'comingsoon') {?>
								<?php echo $_smarty_tpl->tpl_vars['cmsconfig_comingsoon_help']->value;?>

							<?php } elseif ($_smarty_tpl->tpl_vars['action_edit']->value == 'multilang') {?>
								<?php echo $_smarty_tpl->tpl_vars['cmsconfig_multilang_help']->value;?>

							<?php } elseif ($_smarty_tpl->tpl_vars['action_edit']->value == 'plugins') {?>
								<?php echo $_smarty_tpl->tpl_vars['cmsconfig_plugins_help']->value;?>

							<?php } else { ?>
								<?php echo $_smarty_tpl->tpl_vars['cmsconfig_help']->value;?>
...
>
		$(document).ready(function() {
			...
			if ($editor.length > 0) {
				...
				editor.session.setMode("ace/mode/<?php echo $_smarty_tpl->tpl_vars['action_edit']->value;?>
");
...
>
	...
	<?php } elseif ($_smarty_tpl->tpl_vars['action_edit']->value == 'fonts') {?>
...
It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</textarea>
		...
		<?php echo '<script'; ?>
 src="inc/plugins/googlefonts/jquery.fontselect.js"><?php echo '</script'; ?>
>
...
>
	...
	<?php } elseif ($_smarty_tpl->tpl_vars['action_edit']->value == 'seo') {?>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="fa fa-lightbulb-o fa-fw"></span> <strong><?php echo $_smarty_tpl->tpl_vars['legend_add_edit']->value;?>
</strong>
					</div>
					<!-- /.panel-heading -->
					<div class="panel-body">
...
>
			function sbSeoSitemap() {
				...
				$.ajax({
					method: "POST",
					url: "<?php echo @constant('_AM_SITE_URL');?>
inc/plugins/sitemap/sitemap_generator.php",
					data: {}
				})
				.fail(function() {
