...
define('SBADMIN', 'administration');

# Define SBMAGIC ID Files
define('SBMAGICID', 'sbmagic');
...
// --- Defined Safe Pages
// ------------------------ 
$sb_safe_pages_cms   = ['index','news','pages','effectives','graduates'];
...
// --- Protocol
// ------------------------ 
defined('SB_PROTOCOL') OR define('SB_PROTOCOL', 'http://');
defined('SB_PROTOCOL_S') OR define('SB_PROTOCOL_S', 'https://');
