...
$sbsmarty->assign('profile', array(
	...
	'email'                 => $assoc['email'],
	'prenom'                => $sbsanitize->displayLang(sb_utf8_encode($assoc['prenom'])),
	'nom'                   => $sbsanitize->displayLang(sb_utf8_encode($assoc['nom'])),
	'telephone'             => $sbsanitize->displayLang(sb_utf8_encode($assoc['telephone'])),
	'fonction'               => $sbsanitize->displayLang(sb_utf8_encode($assoc['fonction'])),
	'profession'            => $sbsanitize->displayLang(sb_utf8_encode($assoc['profession'])),
	'centres_interet'       => $sbsanitize->displayLang(sb_utf8_encode($assoc['centres_interet'])),
	'infos_complementaires' => $sbsanitize->displayLang(sb_utf8_encode($assoc['infos_complementaires'])),
