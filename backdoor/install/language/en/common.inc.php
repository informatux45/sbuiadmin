...
$arrLang['settings_customer_name'] = "Client name (Admin Login)";
$arrLang['settings_customer_name_info'] = "Name of your client used as a link in your administration to go to your site and also used in the tag 'TITLE' in html (SEO).";
$arrLang['settings_customer_url'] = "Client site url (http<span style='color: red; font-weight: bold;'>s</span>://...) with final <span style='color: red; font-weight: bold;'>/</span>";
