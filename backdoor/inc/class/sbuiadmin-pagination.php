...
class pagination {
    ...
    protected $previousText = SBUIADMIN_GLOBAL_PREV;
    protected $nextText = SBUIADMIN_GLOBAL_NEXT;
	protected $pageInfos = SBUIADMIN_GLOBAL_PAGE_INFOS;
	...
	public function getPageStart() {
		return (($this->getCurrentPage()+1)*$this->getItemsPerPage())-$this->getItemsPerPage()+1;
	}
