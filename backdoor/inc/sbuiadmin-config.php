...
// ------------------------------------------
// --- Defined Safe Pages
$sb_safe_pages   = ['index','sandbox','settings','cache','server','dashboard','theme','database','explorer','users','logaccess','menu','pages','blocs','medias','transfert','cmsconfig','slider','news','contact','tabbs','toggle','gallery','gmaps','table','toolbarck'];
