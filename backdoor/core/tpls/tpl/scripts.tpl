    ...
    <script defer src="assets/adminator/icon-picker.js"></script>
    ...
    <script defer src="assets/adminator/messages.js"></script>
    <script defer src="assets/adminator/dashboard-chart.js"></script>
