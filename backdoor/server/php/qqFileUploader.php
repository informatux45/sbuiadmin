...
class qqFileUploader {
    ...
    /**
     * Get the rewrite filename
     */
    public function sbRewriteString($string) {
        ...
        $ssaccents     = ["A","A","A","A","A","A","a","a","a","a","a","a","O","O","O","O","O","O","o","o","o","o","o","o","E","E","E","E","e","e","e","e","C","c","I","I","I","I","i","i","i","i","U","U","U","U","u","u","u","u","y","N","n"];
        $noValidString = str_replace($accents, $ssaccents, $noValidString);
        $noValidString = iconv($charset = 'utf-8', 'ASCII//TRANSLIT//IGNORE', $noValidString);
        ...
        $noValidString = str_replace("----", "-", $noValidString);
        $noValidString = str_replace("---", "-", $noValidString);
        $validString   = str_replace("--", "-", $noValidString);
    ...
    protected function getUniqueTargetPath($uploadDirectory, $filename) {
        ...
        $unique = $this->sbRewriteString($base);
        $suffix = 0;
