												...
												<tr class="data-row">
													...
													<td>
														<div class="data-cell-actions">
															<span class="btn--icon" style="color:{if $slider.active}var(--success){else}var(--danger){/if}" data-tooltip="Statut {if $slider.active}visible{else}non visible{/if}">
																<svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
															</span>
															<a class="btn--icon" href="{$module_url}&a=photo&sid={$slider.id}" data-tooltip="Toutes les photos">
																<svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg>
															</a>
															<a class="btn--icon" href="{$module_url}&a=sort&sid={$slider.id}" data-tooltip="Trier les photos">
																<svg viewBox="0 0 24 24"><path d="M3 6h18M3 12h18M3 18h18"/></svg>
															</a>
															<a class="btn--icon" href="{$module_url}&a=edit&id={$slider.id}" data-tooltip="Modifier">
																<svg viewBox="0 0 24 24"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 1 1 3 3L7 19l-4 1 1-4z"/></svg>
															</a>
															<a class="btn--icon" data-confirm="Sûr de vouloir supprimer ceci ?" href="{$module_url}&a=del&id={$slider.id}" data-tooltip="Supprimer">
											...
											<tr class="data-row">
												...
												<td>
													<div class="data-cell-actions">
														...
														<a class="btn--icon" href="{$module_url}&a=photoedit&id={$photo.id}&sid={$sid}" data-tooltip="Modifier">
															<svg viewBox="0 0 24 24"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 1 1 3 3L7 19l-4 1 1-4z"/></svg>
														</a>
														<a class="btn--icon" data-confirm="Sûr de vouloir supprimer ceci ?" href="{$module_url}&a=delphoto&sid={$sid}&id={$photo.id}" data-tooltip="Supprimer">
															<svg viewBox="0 0 24 24"><path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m3 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6h14z"/></svg>
														</a>
													</div>
												</td>
