												...
												<tr class="data-row">
													...
													<td>
														<div class="data-cell-actions">
															<span class="btn--icon" style="color:{if $news.active}var(--success){else}var(--danger){/if}" data-tooltip="Statut {if $news.active}visible{else}non visible{/if}">
																<svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
															</span>
															<a class="btn--icon" href="{$module_url}&a=edit&id={$news.id}" data-tooltip="Modifier">
																<svg viewBox="0 0 24 24"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 1 1 3 3L7 19l-4 1 1-4z"/></svg>
															</a>
															<a class="btn--icon" data-confirm="Sûr de vouloir supprimer ceci ?" href="{$module_url}&a=del&id={$news.id}" data-tooltip="Supprimer">
												...
												<tr class="data-row">
													...
													<td>
														<div class="data-cell-actions">
															...
															<a class="btn--icon" href="{$module_url}&a=tpl_list&id={$category.id}" data-tooltip="TPL LIST">
																<svg viewBox="0 0 24 24"><path d="M3 6h18M3 12h18M3 18h18"/></svg>
															</a>
															<a class="btn--icon" href="{$module_url}&a=tpl_single&id={$category.id}" data-tooltip="TPL SINGLE">
																<svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></svg>
															</a>
															<a class="btn--icon" href="{$module_url}&a=settingscategory&id={$category.id}" data-tooltip="Paramètres">
