												...
												<tr class="data-row">
													...
													<td>
														<div class="data-cell-actions">
															<span class="btn--icon" style="color:{if $page.active}var(--success){else}var(--danger){/if}" data-tooltip="Statut {if $page.active}visible{else}non visible{/if}">
																<svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
															</span>
															<a class="btn--icon" href="{$module_url}&a=edit{if $page.url_custom != ''}custom{/if}&id={$page.id}" data-tooltip="Modifier">
															...
															<a class="btn--icon" data-confirm="Sûr de vouloir supprimer ceci ?" href="{$module_url}&a=del&id={$page.id}" data-tooltip="Supprimer">
